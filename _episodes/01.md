...
So far you’ve learned how to print a message on the console window using the `print` statement 
  

This is a way of telling the interpreter to output the value stored in a given variable on the console(screen). 
##Introducing input
